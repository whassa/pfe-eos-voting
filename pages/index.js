...
export default function Home({ ual, privateKey, eosAccountName }) {
    ...
    const fetchResolutinInfo = (page) => {
        getProposals(privateKey, eosAccountName, state.sortInfo.next_key).then(
            (value) => {
                dispatch({
                    type: types.RESOLUTION_FETCHED,
                    resolutions: value.rows,
        ...
        <>
            ...
            >
                <Box sx={{ float: "right", display: "flex" }}>
                    ...
                    <IconButton
                        color={
                            state.view === "listView" ? "secondary" : "primary"
                        }
                    ...
                    <IconButton
                        color={
                            state.view === "gridView" ? "secondary" : "primary"
                        }
